...
def define_discriminator(in_shape=(187,1), n_classes=5):
...
def load_real_samples():
    # load dataset
    df29 = pd.read_csv('mitbih_train.csv',header=None)
    dataset=df29.values
...
def summarize_performance(step, g_model, latent_dim, n_samples=100):
    ...
    [X, nmn_label], nmn_y = generate_fake_samples(g_model, latent_dim, n_samples)
...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=4000, n_batch=64):
